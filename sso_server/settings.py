...
OIDC_TEMPLATES = {
    'authorize ': 'sso_app/oidc_provider/authorize.html',
    'error ': 'sso_app/oidc_provider/error.html',
...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "Scramble Solutions",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "ScrambleSolutions",
    ...
    "welcome_sign": "Welcome to the Scramble Solutions",

    # Copyright on the footer
    "copyright": "Scramble Solutions",
    ...
    "order_with_respect_to": ["auth", "oidc_provider"],
    ...
    "icons": {
        ...
        "oidc_provider.RSAKey": "fas fa-key",
        # "oidc_provider.Token": "fas fa-coins",
    },
