...
3. **Integration Code Guide**
   ...
   Here are some code Examples for OICD integration guide
   
   1. [PHP](https://github.com/jumbojett/OpenID-Connect-PHP)
   2. Python
    ...
    Assuming you have a way to capture the redirected URL
